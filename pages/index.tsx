  ...
  <Layout title="Coming Soon">
    ...
    <div className="relative z-10 py-6 space-y-16 lg:space-y-32 text-gray-900">
      <div className="text-center space-y-10">
        ...
        <h1 className="text-7xl lg:text-9xl font-extrabold">Gala Batik</h1>
        <h2 className="font-light text-xl tracking-wider">A premium batik art originated in Surabaya. </h2>
        <p className="text-xl lg:text-2xl tracking-wide mx-10 lg:max-w-xxl lg:mx-auto">
          Stay in touch!
        </p>
      </div>
    ...
    <div className="absolute bottom-5">
      <ul className="flex space-x-3">
        <li>
          <Link href="https://instagram.com/galabatikboutique">
        ...
        <li>
          <Link href="https://galabatik.biz.id">
            <a className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-50 transition ease-in-out duration-500 hover:bg-red-500 hover:text-white hover:shadow-lg">
              <svg
                className="w-6 h-6"
                fill="currentColor"
